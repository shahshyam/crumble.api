...
router.get('/api/updateribbon', (req, res) => {
    ...
    if (tabId) {
        ...
        .ele('button')
            ...
            .up()
            .ele('button')
            .att('id', 'remote_command_activesheet')
            .att('label', 'ActivesheetTest')
            .att('tag', 'activesheet.newworkbook')
            .att('size', 'normal')
            .att('onAction', 'OnClickAction')
            .up()
            .ele('button')
            .att('id', 'remote_command_workbook')
            .att('label', 'ActiveWorkbookTest')
            .att('tag', 'activeworkbook.newworkbook')
            .att('size', 'normal')
            .att('onAction', 'OnClickAction')
            .up()
            .up()
